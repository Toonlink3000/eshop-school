...
{l
    ...
    $user = \DB\GetConnection()->msqli_real_escape_string($user_id);
    $product = \DB\GetConnection()->msqli_real_escape_string($product_id);
    $address = \DB\GetConnection()->msqli_real_escape_string($address_raw);
